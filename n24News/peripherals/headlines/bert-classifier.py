...
train_encodings = tokenizer(train_headlines, truncation=True, padding='max_length', return_tensors='pt', max_length=35)
train_input_ids = train_encodings['input_ids']
train_attention_masks = train_encodings['attention_mask']

val_encodings = tokenizer(val_headlines, truncation=True, padding='max_length', return_tensors='pt', max_length=35)
val_input_ids = val_encodings['input_ids']
val_attention_masks = val_encodings['attention_mask']

test_encodings = tokenizer(test_headlines, truncation=True, padding='max_length', return_tensors='pt', max_length=35)
...
for epoch in range(num_epochs):
    ...
    if val_accs[-1] > best_val_acc:
        ...
        np.save('train_headlines_peripheral.npy', train_cls_hidden_states)
        ...
        np.save('val_headlines_peripheral.npy', val_cls_hidden_states)
        ...
        np.save('test_headlines_peripheral.npy', test_cls_hidden_states)
