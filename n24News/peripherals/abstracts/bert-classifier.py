...
train_encodings = tokenizer(train_abstracts, truncation=True, padding='max_length', return_tensors='pt', max_length=75)
train_input_ids = train_encodings['input_ids']
train_attention_masks = train_encodings['attention_mask']

val_encodings = tokenizer(val_abstracts, truncation=True, padding='max_length', return_tensors='pt', max_length=75)
val_input_ids = val_encodings['input_ids']
val_attention_masks = val_encodings['attention_mask']

test_encodings = tokenizer(test_abstracts, truncation=True, padding='max_length', return_tensors='pt', max_length=75)
...
train_shuffled_dataloader = DataLoader(train_dataset, shuffle=True, batch_size=128)
train_ordered_dataloader = DataLoader(train_dataset, batch_size=128)
...
for epoch in range(num_epochs):
    ...
    if val_accs[-1] > best_val_acc:
        ...
        np.save('train_abstracts_peripheral.npy', train_cls_hidden_states)
        ...
        np.save('val_abstracts_peripheral.npy', val_cls_hidden_states)
        ...
        np.save('test_abstracts_peripheral.npy', test_cls_hidden_states)
