...
accCirc = 0.8592193369263433
TCirc = 1.2297893189612934      
# plt.plot(TCirc, accCirc, 'ro', markersize=30, fillstyle='none', markeredgewidth=3)

accCirc = 0.8507267679242202
TCirc = 1.2422015351951659
# plt.plot(TCirc, accCirc, 'ro', markersize=30, fillstyle='none', markeredgewidth=3)

plt.xlabel('Mean T', fontsize=20)
plt.ylabel('Accuracy', fontsize=20)
plt.legend(loc='lower right', fontsize=20)
labels = ['Headline', 'Abstract', 'Image', 'Caption', 'Body 1']
plt.xticks(range(5), labels, fontsize=15)
